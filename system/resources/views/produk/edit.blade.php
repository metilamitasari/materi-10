			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="file" class="form-control" name="foto" value="{{$produk->foto}}" accepted=".png">
							</div>
					...
					<div class="form-group">
						...
						<textarea name="deskripsi" id="deskripsi" class="form-control" row="5">{{$produk->deskripsi}}</textarea>
					</div>
